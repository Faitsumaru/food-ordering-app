                ...
                <div className="p-10 rounded-xl z-10 w-full h-full bg-black">
                    ...
                    <form className="w-full space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            id="password"
                            type="password"
                            className="block appearance-none w-full px-3 py-2 mb-6 border border-gray-300 roundedn-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-gray-200 focus:border-gray-200"
                            />
                        </div>
